class ContentPartnersController < ApplicationController
  ...
  def create
    ...
    content_partner_params = {
      name: params[:content_partner][:name],
      description: params[:content_partner][:description],
      abbreviation: params[:content_partner][:abbreviation],
      url: params[:content_partner][:url],
      logo: params[:content_partner][:logo]
    }
  ...
  def show
    ...
    returned_content_partner["resources"].each do |resource|
      resources << Resource.new(
        ...
        type: resource["type"],
        path: resource["path"],
        last_harvested_at: resource["last_harvested_at"],
        harvest_frequency: resource["harvest_frequency"],
        day_of_month: resource["day_of_month"],
        nodes_count: resource["nodes_count"],
        position: resource["position"],
        is_paused: resource["is_paused"],
        is_approved: resource["is_approved"],
        is_trusted: resource["is_trusted"],
        is_autopublished: resource["is_autopublished"],
        is_forced: resource["is_forced"],
        ...
        default_license_string: resource["default_license_string"],
        default_rights_statement: resource["default_rights_statement"],
        default_rights_holder: resource["default_rights_holder"],
        default_language_id: resource["default_language_id"],
    ...
    @content_partner = ContentPartner.new(
      ...
      description: returned_content_partner["description"],
      logo: returned_content_partner["logoPath"],
      created_at: returned_content_partner["returned_content_partner"],
      resources: resources,
