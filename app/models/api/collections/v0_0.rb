    ...
    class V0_0 < Api::Methods
      ...
      def self.prepare_hash(collection, params)
        ...
        collected_pages.each do |collected_page|
          counts['articles'].nil? ? counts['articles'] = collected_page.articles.count :
            counts['articles'] += collected_page.articles.count
          counts['images'].nil? ? counts['images'] = collected_page.media.where(subclass: 0).count :
            counts['images'] += collected_page.media.where(subclass: 0).count
          counts['video'].nil? ? counts['video'] = collected_page.media.where(subclass: 1).count :
            counts['video'] += collected_page.media.where(subclass: 1).count
          counts['sounds'].nil? ? counts['sounds'] = collected_page.media.where(subclass: 2).count :
            counts['sounds'] += collected_page.media.where(subclass: 2).count
