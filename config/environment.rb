...
GET_IMAGE_RESIZED_RESOURCES = "localhost:8084/scheduler/getImageResizedResources"
# GET_IMAGE_RESIZED_RESOURCES = "http://172.16.0.161:80/scheduler/getImageResizedResources"
GET_MEDIA_OF_RESOURCE = "getMediaOfResource"
